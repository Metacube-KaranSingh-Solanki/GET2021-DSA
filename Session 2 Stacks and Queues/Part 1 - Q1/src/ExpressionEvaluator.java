 ...
 * !), and parentheses. assumes the expression has only integer constants, and
 * the tokens are separated using spaces
 */
public class ExpressionEvaluator {
	...
	/**
	 * Helper method to check the precedence of the operators, high integer value
	 * means high precedence
	 * 
